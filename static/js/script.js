/**
 * AES Visualizer JavaScript
 * Optimized and organized version
 */

// ===== Constants =====

// Embedded icons as data URIs to reduce HTTP requests
...
// Theme icons using HTML entities
...
/**
 * Initializes copy buttons to copy table content to clipboard
 */
...
/**
 * Initializes toggle buttons for showing/hiding detailed explanations
 */
...
/**
 * Sets up character counters for input fields
 * Shows visual feedback when the input reaches the required length
 */
...
/**
 * Sets up the toggle button for showing/hiding rounds 2-9
 */
...
/**
 * Animates the visualization steps with a staggered effect
 */
function animateVisualizationSteps() {
